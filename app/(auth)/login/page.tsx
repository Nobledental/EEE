...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center gradient-mesh p-4 overflow-hidden relative">
            {/* Background elements */}
            <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-teal-500/10 rounded-full blur-[120px] animate-float" />
            ...
            <div className="w-full max-w-md space-y-8 relative z-10 animate-fade-in">
                <div className="flex flex-col items-center text-center space-y-4">
                    <div className="relative group">
                        ...
                        <div className="relative h-16 w-16 bg-white rounded-2xl flex items-center justify-center shadow-xl shadow-teal-500/20 border border-teal-100">
                ...
                <Card className="glass border-0 shadow-2xl shadow-slate-200/50 overflow-hidden">
                    ...
                    <CardContent className="grid gap-6">
                        <form onSubmit={onSubmit} className="space-y-4">
                            <div className="space-y-4">
                                ...
                                <Button
                                    className="w-full h-12 gradient-primary text-white font-bold rounded-xl shadow-lg shadow-teal-500/20 hover:shadow-xl hover:shadow-teal-500/40 transition-all group"
                                    type="submit"
                                    disabled={isLoading}
                                >
                                    {isLoading ? (
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            <Button
                                ...
                                type="button"
                                disabled={isLoading}
                                className="h-11 border-slate-200 bg-white/50 hover:bg-slate-50 transition-all font-semibold"
                            >
                    ...
                    <CardFooter className="flex flex-col space-y-4 pt-2 pb-8 text-center bg-slate-50/50 backdrop-blur-sm border-t border-slate-100">
